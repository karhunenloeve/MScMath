...
Finally, we develop a Mayer--Vietoris principle for ample groupoids with topological coefficients.
...
Combined with the universal coefficient theorem in the discrete regime, it cleanly isolates how torsion in integral homology contributes additional homology through \(\operatorname{Tor}_1^{\mathbb Z}\), a phenomenon illustrated later on examples built from standard ample groupoids such as those arising from shifts of finite type.